...
void servo_init(void)
{
	...
	GPIOA->MODER &= ~(GPIO_MODER_MODER1_Msk | GPIO_MODER_MODER2_Msk | GPIO_MODER_MODER3_Msk | GPIO_MODER_MODER8_Msk | GPIO_MODER_MODER9_Msk | GPIO_MODER_MODER10_Msk| GPIO_MODER_MODER11_Msk);
	GPIOA->MODER |= (0x02<<GPIO_MODER_MODER1_Pos)| (0x02<<GPIO_MODER_MODER2_Pos)| (0x02<<GPIO_MODER_MODER3_Pos)| (0x02<<GPIO_MODER_MODER8_Pos)| (0x02<<GPIO_MODER_MODER9_Pos)| (0x02<<GPIO_MODER_MODER10_Pos)| (0x02<<GPIO_MODER_MODER11_Pos);

	//Set alternate function AF1 for pin 0/1/2/3 and function AF5 for pin 6/7
	GPIOA->AFR[0] &= ~(0x0000FFF0);
	GPIOA->AFR[0] |=  (0x00001110);
